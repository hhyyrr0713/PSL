...
LIST_URL = "https://nxapi.lfmall.co.kr/exhibition/search/v1/brandGroup/1002"
BANNER_BRAND_CODE = "HZ"
LIST_BRAND_ID = "HZ"

CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
BASE_DIR = os.path.dirname(CURRENT_DIR)
DATA_DIR = os.path.join(BASE_DIR, "data")
SAVE_PATH = os.path.join(DATA_DIR, "hazzys_men_products_enriched_all.csv")
