...
COMMON_HEADERS = {
    ...
    "X-REQUEST-TOKEN": "7TV/+t+YtGHTCvoyiARRNKCW28aPthUefSK+moZey0o=",
...
LIST_URL = "https://nxapi.lfmall.co.kr/exhibition/search/v1/brandGroup/1017"
BANNER_BRAND_CODE = "JN"

CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
BASE_DIR = os.path.dirname(CURRENT_DIR)
DATA_DIR = os.path.join(BASE_DIR, "data")
SAVE_PATH = os.path.join(DATA_DIR, "jillstuartnewyork_men_products_enriched_all.csv")
...
def get_wish_count(product_code: str) -> int:
    ...
    if isinstance(body, dict):
        return body.get("wishCount", 0) or 0
    ...
    for page in range(1, total_page + 1):
        ...
        for idx, p in enumerate(products, start=1):
            ...
            row = {
                ...
                "display_category_id": p.get("displayCategoryId"),
