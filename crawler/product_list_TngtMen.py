...
BANNER_BRAND_CODE = "B000"

CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
BASE_DIR = os.path.dirname(CURRENT_DIR)
DATA_DIR = os.path.join(BASE_DIR, "data")
SAVE_PATH = os.path.join(DATA_DIR, "tngt_men_products_enriched_all.csv")
...
def main():
    ...
    df = df[[
        ...
        "season_name_raw", "season_spring", "season_summer",
        "season_fall", "season_winter", "season_all",
