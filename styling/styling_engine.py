...
def build_two_piece_sets_for_bottom_anchor(
    ...
    for _, top_row in top_df.iterrows():
        ...
        rows.append({
            ...
            "anchor_image_url": anchor_item.get("image_url", ""),
            "anchor_image_url_00": anchor_item.get("image_url_00", ""),
            "anchor_image_url_01": anchor_item.get("image_url_01", ""),
            "anchor_image_url_02": anchor_item.get("image_url_02", ""),
            ...
            "bottom_image_url": anchor_item.get("image_url", ""),
            "bottom_image_url_00": anchor_item.get("image_url_00", ""),
            "bottom_image_url_01": anchor_item.get("image_url_01", ""),
            "bottom_image_url_02": anchor_item.get("image_url_02", ""),
            "top_product_code": top_row.get("product_code", ""),
            "top_product_name": top_row.get("product_name", ""),
            "top_image_url": top_row.get("image_url", ""),
            "top_image_url_00": top_row.get("image_url_00", ""),
            "top_image_url_01": top_row.get("image_url_01", ""),
            "top_image_url_02": top_row.get("image_url_02", ""),
            "outer_product_code": "",
            "outer_product_name": "",
            "outer_image_url": "",
            "outer_image_url_00": "",
    ...
    for _, top_row in top_df.iterrows():
        for _, outer_row in outer_df.iterrows():
            ...
            rows.append({
                ...
                "outer_image_url": outer_row.get("image_url", ""),
                "outer_image_url_00": outer_row.get("image_url_00", ""),
                "outer_image_url_01": outer_row.get("image_url_01", ""),
                "outer_image_url_02": outer_row.get("image_url_02", ""),
                "bottom_top_score": bt_score,
...
def build_two_piece_sets_for_top_anchor(
    ...
    for _, bottom_row in bottom_df.iterrows():
        ...
        rows.append({
            ...
            "bottom_image_url": bottom_row.get("image_url", ""),
            "bottom_image_url_00": bottom_row.get("image_url_00", ""),
            "bottom_image_url_01": bottom_row.get("image_url_01", ""),
            "bottom_image_url_02": bottom_row.get("image_url_02", ""),
            "top_product_code": anchor_item.get("product_code", ""),
            "top_product_name": anchor_item.get("product_name", ""),
            "top_image_url": anchor_item.get("image_url", ""),
            "top_image_url_00": anchor_item.get("image_url_00", ""),
            "top_image_url_01": anchor_item.get("image_url_01", ""),
            "top_image_url_02": anchor_item.get("image_url_02", ""),
            "outer_product_code": "",
            "outer_product_name": "",
            "outer_image_url": "",
            "outer_image_url_00": "",
...
def build_two_piece_sets_for_outer_anchor(
    ...
    for _, top_row in top_df.iterrows():
        ...
        rows.append({
            ...
            "outer_image_url": anchor_item.get("image_url", ""),
            "outer_image_url_00": anchor_item.get("image_url_00", ""),
            "outer_image_url_01": anchor_item.get("image_url_01", ""),
            "outer_image_url_02": anchor_item.get("image_url_02", ""),
